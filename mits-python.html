...
<head>
  ...
  <title>Acadable - coding, college, and internship</title>
  <script>window.location.replace("https://wiki.python.org/moin/BeginnersGuide/Programmers");</script>

  <!-- 
    - favicon
  -->
  <link rel="shortcut icon" href="./fevicon.svg" type="image/svg+xml">
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <h1>
        <a href="#" class="logo"><img  width="110px" src="./assets/images/logo.png" alt=""></a>
      </h1>

      <nav class="navbar" data-navbar>

        <div class="navbar-top">
          <a href="#" class="logo"><img  width="80px" src="./assets/images/logo.png" alt=""></a>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="#event" class="navbar-link" data-nav-toggler>Certification Exams</a>
          </li>

          <li class="navbar-item">
            <a href="https://www.acadable.com/path-to-success.html" class="navbar-link" data-nav-toggler>Next Workshop</a>
          </li>

          <li class="navbar-item">
            <a href="https://courses.acadable.com/contactus" class="navbar-link" data-nav-toggler>Contact</a>
          </li>
      ...
      <div class="header-actions">
        ...
        <a href="https://courses.acadable.com/s/authenticate?url=/t/u/activeCourses" class="header-action-btn login-btn">
    ...
    <article>
      ...
      <section class="hero" id="home" aria-label="hero" style="background-image: url('./assets/images/hero-bg.jpg')">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <h2 class="h1 hero-title">Master Coding with Expert-Led Courses</h2>

            <p class="hero-text">
              Unlock the Future of Coding with Expert-Led Live Courses & Self-Paced Learning.
            </p>

            <a href="https://courses.acadable.com/s/store" class="btn btn-primary">
          ...
          <div class="about-content">
            ...
            <ul class="about-list">
              ...
              <li class="about-item">
                ...
                <div>
                  <h3 class="h3 item-title">Learn from the Best</h3>

                  <p class="item-text">
                    Expert-led courses designed to inspire and elevate your coding skills.
                  </p>
                </div>
              ...
              <li class="about-item">
                ...
                <div>
                  <h3 class="h3 item-title">Tailored for You</h3>

                  <p class="item-text">
                    Personalized live sessions and self-paced learning at your fingertips.
                  </p>
                </div>
              ...
              <li class="about-item">
                ...
                <div>
                  <h3 class="h3 item-title">Code Your Future</h3>

                  <p class="item-text">
                    Master top programming languages with hands-on projects and real-world challenges.
                  </p>
                </div>
            ...
            <a href="#" class="btn btn-primary">
              <span class="span">Book a demo</span>
        ...
        <div class="container">
          ...
          <div class="cta-content">
            ...
            <p class="section-text">
              Join Acadable's free workshop to kickstart your coding journey! Perfect for beginners, this session offers hands-on learning with expert guidance. Whether you're new to programming or want to sharpen your skills, this is your chance to dive into coding and start building your future. Sign up today!
            </p>

            <a href="https://courses.acadable.com/sessions" class="btn btn-secondary">
      ...
      <section class="section event" id="event" aria-label="event">
        <div class="container">
          ...
          <p class="section-subtitle">Certification Exam</p>

          <h2 class="h2 section-title">Not a product, It's an Exam</h2>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="event-card">
                ...
                <time class="badge" datetime="2022-12-04">Java</time>
                ...
                <div class="card-content">
                  ...
                  <address class="card-address">
                    ...
                    <span class="span">Online Exam + Interview</span>
                  </address>

                  <h3 class="h3">
                    <a href="#" class="card-title">Authentic Java Certification Examination</a>
                  </h3>
            ...
            <li>
              <div class="event-card">
                ...
                <time class="badge" datetime="2022-10-30">Python</time>
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="#" class="card-title">Authentic Python Certification Examination</a>
                  </h3>
            ...
            <li>
              <div class="event-card">
                ...
                <time class="badge" datetime="2022-09-18">C++</time>
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="#" class="card-title">Authentic C++ Certification Examination</a>
                  </h3>
    ...
    <div class="container">
      ...
      <div class="footer-top">
        ...
        <div class="footer-brand">
          ...
          <a href="#" class="logo">Acadable</a>

          <p class="section-text">
            Acadable empowers students with essential coding skills, college preparation, and internship opportunities, paving the way for successful careers in tech and beyond.
          </p>
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="tel:+919691600315" class="footer-link">+91 9691600315</a>
          </li>

          <li class="footer-item">
            <ion-icon name="call" aria-hidden="true"></ion-icon>

            <a href="tel:+917015030315" class="footer-link">+91 7015030315</a>
          </li>

          <li class="footer-item">
            <ion-icon name="mail-outline" aria-hidden="true"></ion-icon>

            <a href="mailto:contact@acadable.com" class="footer-link">contact@acadable.com</a>
          </li>
      ...
      <div class="footer-bottom">
        <p class="copyright">
          Copyright 2024 Acadable. All Rights Reserved by <a href="https://www.acadable.com" class="copyright-link">Acadable</a>
        </p>
      </div>
